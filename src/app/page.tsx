                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-4 gap-1.5 pt-2 border-t border-slate-100 font-mono text-[11px] font-bold mt-2">
                        ...
                        {customer.address ? (
                          <a href={`http://maps.google.com/?q=${encodeURIComponent(customer.address.split(/[\s\(\環境]/)[0])}`} target="_blank" rel="noopener noreferrer" className="bg-green-200 hover:bg-green-100 text-black-200 border border-green-300 text-slate-900 rounded-lg shadow-2xs text-center py-2"><span>導航</span></a>
